...
public class HtmlFormServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        out.printf("<html>%n%n");
        out.printf("<head><title>%s</title></head>%n", "Form1");
    ...
    private static void printForm(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.printf("Enter name:<br><input type=\"text\" name=\"name\"><br>"); // name will store in this name variable and pass name as parameter to doPost()
