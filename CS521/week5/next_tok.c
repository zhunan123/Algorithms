...
int main(void)
{
    ...
    /* How to do this in Java-style:
    *       what would our function return? array of strings
    *       malloc an initial array
    *       loop through the source source
    *       when we find a delimiter, we will:
    *           potentially dynamically resize the array
    *           put into that array of strings
